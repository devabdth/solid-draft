...
const HowItWorksSection = () => {
  return (
    <section className="w-full default-container h-[30vw] flex flex-col items-center justify-between py-12 gap-4">
      ...
      <div className="w-full h-full flex flex-row items-center justify-between gap-8">
        {HOW_IT_WORKS_SNIPPETS.map((snippet, i) => (
          <div key={i} className="w-[25vw] relative h-full">
            <div className="w-[24vw] h-[14vw] rounded-xl bg-variant absolute bottom-0 left-[50%] -translate-x-[50%] flex flex-col items-center justify-center gap-2 px-8">
